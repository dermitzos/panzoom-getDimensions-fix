...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function Panzoom(elem, options) {
        ...
        var originalDimensions = getDimensions(elem).elem;
        function resetDimensions(entries) {
            originalDimensions.width = entries[0].contentRect.width;
            originalDimensions.height = entries[0].contentRect.height;
        }
        var observer = new ResizeObserver(resetDimensions);
        ...
        function constrainXY(toX, toY, toScale, panOptions) {
            ...
            if (opts.contain) {
                ...
                var realWidth = originalDimensions.width;
                var realHeight = originalDimensions.height;
        ...
        function constrainScale(toScale, zoomOptions) {
            ...
            if (opts.contain) {
                var dims = getDimensions(elem);
                var elemWidth = originalDimensions.width;
                var elemHeight = originalDimensions.height;
